...
public class reporte extends javax.swing.JFrame {
    ...
    void validarBoton(){
        String boton="";
        boton=this._direccion.leerRol();
        if(!boton.isEmpty()){
            if(boton.equals("admin")){
                this.guardar.setText("Procesar");
            }else if(boton.equals("usuario")){
    ...
    private void initComponents() {
        ...
        tiempoTrabajo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tiempoTrabajoKeyReleased(evt);
            }
        });
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        try {
            ...
            if(guardar.getText().equals("Guardar")){
                 this.crearReporte();
            }else if(guardar.getText().equals("Procesar")){
...
/////valido los caracteres que se van a meter, verificando que solo sean numeros, si no, se borran
    private void tiempoTrabajoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tiempoTrabajoKeyReleased
        // TODO add your handling code here:
         String str = tiempoTrabajo.getText();
        ...
        if(error){
            ...
            tiempoTrabajo.setText(new String(resultado,0,j));

        } 
        
        
    }//GEN-LAST:event_tiempoTrabajoKeyReleased

    private void fechaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_fechaKeyReleased
        // TODO add your handling code here:
        String str = fecha.getText();
        ...
        if(error){
            ...
            fecha.setText(new String(resultado,0,j));
    ...
    private void horaInicioKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_horaInicioKeyReleased
        // TODO add your handling code here:
         String str = horaInicio.getText();
        ...
        if(error){
            ...
            horaInicio.setText(new String(resultado,0,j));

        }  
        
        
    }//GEN-LAST:event_horaInicioKeyReleased

    private void nombreClienteKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nombreClienteKeyReleased
        // TODO add your handling code here:
         String str = nombreCliente.getText();
        ...
        for(int i=0; i<fuente.length;i++){
            ...
            }else if(fuente[i]>='a'&&fuente[i]>='A'&&fuente[i]<='z'&&fuente[i]<='Z'){
                     resultado[j++] = fuente[i];
        ...
        if(error){
            ...
            nombreCliente.setText(new String(resultado,0,j));
    ...
    void crearReporte() throws IOException{
        ...
        if(!this.nombreCliente.getText().isEmpty()&&!this.fecha.getText().isEmpty()&&
            ...
            if(this.poliza.isSelected()==true){
             ...
             _conexion.mariaDB();
             String []parts=this.nombreCliente.getText().split("\\|");
             String partaux="";
             if(parts.length<=1){
                 partaux=parts[0];
             }else{
            ...
            if(!_direccion.leeridReporte().isEmpty()){
                ...
                if(_conexion.verificarDato("select * from reportes where id="+idr+"")){
                    ...
                    if(validar==JOptionPane.OK_OPTION){
                       ...
                       _conexion.update("update reportes set fecha='"+this.fecha.getText()+"', horaInicio='"+this.horaInicio.getText()+"', idCliente='"+parts[0]+"',"
                               + "poliza='"+pol+"', persona='"+this.personas.getText()+"', asesor='"+this.asesorOtro.getText()+"',"
                                       + "personas='"+this.personas.getText()+"', tiempoTrabajo='"+this.tiempoTrabajo.getText()+"',"
                                               + "servicioRealizado='"+this.descripcionServicio.getText()+"', materiales='"+this.observacionesMateriales.getText()+"',"
                                                       + "procesado=0, idUsuario='"+this._direccion.leerUsuario()+"', nomCliente='"+partaux+"', revisado=0 where id="+idr+"");
                       this.limpiar();
            limpiarInfor();
                    }else{
                ...
                + "materiales, procesado, idUsuario, nomCliente, revisado) values('"+this.fecha.getText()+"','"+this.horaInicio.getText()+"',"
                    + "'"+parts[0]+"','"+pol+"','"+this.personas.getText()+"','"+this.asesorOtro.getText()+"',"
                    + "'','"+this.tiempoTrabajo.getText()+"','"+this.descripcionServicio.getText()+"','"+this.observacionesMateriales.getText()+"',"
                    + "0,'"+this._direccion.leerUsuario()+"','"+partaux+"',0)";
    ...
    void mostrarDatosalmacenados(){
        ...
        if(!_direccion.idCliente().isEmpty()||!_direccion.setcliente().isEmpty()){
            this.nombreCliente.setText(_direccion.idCliente()+" |"+_direccion.setcliente());
        }
    ...
    void procesarReporte() throws IOException{
        ...
        if(!idr.isEmpty()){
            _conexion.update("update reportes set procesado=1 where id="+idr+""); 
            this.limpiarInfor();
            this.limpiar();
            this.dispose();
        }else{
