...
direccion _direccion= new direccion();
    void loging() throws IOException{
        ...
        String usuario=this.usuario.getText(), contrasenia=this.contrasenia.getText();
        if(!usuario.isEmpty()&&!contrasenia.isEmpty()){
            String respuesta=_conector.devolverDato("select rol from usuarios where usuario='"+usuario+"' and contrasenia='"+contrasenia+"'","rol");
            System.out.println(""+respuesta);
            switch (respuesta) {
                case "admin":
                    _conector.cerrarConeccion();
                    _direccion.guardarUsuario(usuario);
                    _direccion.guardarRol(respuesta);
                    _admin= new admin();
